...
| **Quarter 3** | RedTrade — *Real Upgrade* | • Main: Budget-sensitive tool users <br> • Sub: Legacy gas/electric users | POS; Facebook Ads; Zalo | • Trade-in program <br> • Bundled starter kits <br> • Zalo onboarding push |
...
| **Quarter 4** | RedTalk Live | • Main: Zalo leads & active users <br> • Sub: Loyalists; site-level advocates | Zalo; Facebook Live | • Weekly mini tutorials <br> • Tool hacks & maintenance advice <br> • Hosted by trade KOLs |
