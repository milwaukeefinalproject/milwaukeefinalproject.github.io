...
|                       | Lead Database Size                       | Contacts        | 5K                  | ≥ 30K qualified leads               |

:::

## Tracking Methods

To ensure ongoing visibility into campaign performance, Milwaukee Vietnam will implement a structured tracking framework combining digital analytics, offline reporting, and third-party surveys. Each KPI is linked to a specific tracking tool and review frequency, enabling consistent measurement and timely course correction [(Table 15)](#tb15).
...
- Zalo communication: Manual form exports will consolidate lead generation, demo registrations, and RedTalk Live participation into actionable sales pipelines.
...
::: {tab-Tracking}
<a id="tb15"></a>*Table 15. Tracking Methods*
...
| **Demo Registrations**    | Zalo export, onsite QR scan tracking                     | Event-based           |
...
| **Zalo Leads**             | Manual form exports                                       | Monthly               |
